...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('admin.quiz-attempts') }}" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm">
    ...
    <div class="row">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-6">
                            <p class="mb-0">{{ $quizAttempt->user->username }}</p>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-6">
                            <p class="mb-0"><strong>Quiz:</strong></p>
                        </div>
                        <div class="col-6">
                            <p class="mb-0">{{ $quizAttempt->quiz->text ?? 'N/A' }}</p>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <p class="mb-0">{{ $quizAttempt->score }}%</p>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <p class="mb-0">{{ $quizAttempt->created_at->format('M d, Y H:i') }}</p>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <p class="mb-0">{{ $quizAttempt->time_taken }} seconds</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    @if($quizAttempt->quiz && $quizAttempt->quiz->answers->count() > 0)
                    <div class="list-group">
                        @foreach($quizAttempt->quiz->answers as $answer)
