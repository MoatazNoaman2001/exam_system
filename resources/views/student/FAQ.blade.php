...
<div class="container py-5">
    ...
    <div class="faq-header text-center">
        <h1 class="fw-bold mb-3">{{ __('faq.title') }}</h1>
        <p class="lead mb-4">{{ __('faq.subtitle') }}</p>
    ...
    <div id="noResults" class="no-result-card d-none">
        ...
        <h4 class="text-primary mb-2">{{ __('faq.no_results.title') }}</h4>
        <p class="text-muted mb-4">{{ __('faq.no_results.subtitle') }}</p>
        <button id="resetSearch" class="btn btn-primary px-4">{{ __('faq.no_results.button') }}</button>
    </div>

    <!-- Help Section -->
    <div class="help-section text-center">
        <h3 class="text-primary mb-3">{{ __('faq.need_more_help') }}</h3>
        <p class="mb-4">{{ __('faq.support_available') }}</p>
        <a href="{{ route('contact.us') }}" class="btn btn-primary mx-2">
            <i class="bi bi-headset me-2"></i> {{ __('faq.contact_us') }}
        </a>
    </div>
</div>
